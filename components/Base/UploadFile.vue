<template>
  <ClientOnly>
    <div
      class="relative mt-4 p-3.5 cursor-pointer flex flex-col items-center justify-center border-dashed border-2 border border-primary-background rounded-lg hover:bg-primary-background"
    ...
    >
      ...
      <template v-if="_preview">
        ...
        <div
          class="w-[36px] h-[36px] absolute -top-3 -right-3 flex items-center justify-center bg-neutral-lightest rounded-full z-10"
      ...
      <template v-else>
        <div class="flex">
          ...
          <svg class="w-8 h-8 text-gray-200" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <div class="mt-2 text-center text-body-2 text-gray-400">
          Drag & drop file <br />
